...
class Cart extends Model{
	...
	public static function getFromSession()
	{
		...
		if(isset($_SESSSION[Cart::SESSION]) && (int)$_SESSSION[Cart::SESSION]['idcart'] > 0){

			$cart->get((int)$_SESSSION[Cart::SESSION]['idcart']);
	...
	public function setToSession()
	{
		...
		$_SESSSION[Cart::SESSION] = $this->getValues();
	...
	public static function setMsgError($msg)
	{
		...
		$_SESSSION[Cart::SESSION_ERROR] = $msg;
	...
	public static function getMsgError()
	{
		...
		$msg = (isset($_SESSSION[Cart::SESSION_ERROR])) ? $_SESSSION[Cart::SESSION_ERROR] : "";
	...
	public static function clearMsgError()
	{
		...
		$_SESSSION[Cart::SESSION_ERROR] = NULL;
